...
<header style='border-bottom:1px solid #ccc; padding:0px 0; text-align:left; background-color: #000000; overflow:hidden;'>
	...
	<ul class="nav-list">
		...
		<li class="nav-list"><a class="${category eq 'no' ? 'active' : ''} nav" href='list.no'>공지사항</a></li>
		<li class="nav-list"><a class="${category eq 'pd' ? 'active' : ''} nav" href='product.pd'>상품</a></li>
...
.category li a:hover,
.category li a.active { font-weight:bold; background-color:#ddd; color:#000; }
</style>