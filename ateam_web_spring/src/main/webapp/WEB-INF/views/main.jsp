...
<body>
	<div style="max-width: 950px; padding-bottom: 20px">
	...
	<div class="row tm-row">
		<article class="col-12 col-md-6 tm-post">
			...
			<a href="list.no" class="effect-lily tm-post-link tm-pt-45">
			...
			<p class="tm-pt-30">여기에 내용을 띄우던지 사진을 날려서 리스트를 띄우던지 해야함</p>
		...
		<article class="col-12 col-md-6 tm-post">
			...
			<p class="tm-pt-30">여기는 심볼 이미지 1개, 알림, 타이틀 이름만 있으면 될까..?</p>
			<div class="d-flex justify-content-between tm-pt-45">
				<span class="tm-color-primary">Creative . Design . Business</span> <span
					class="tm-color-primary">June 16, 2020</span>
			</div>
			<hr>
			<div class="d-flex justify-content-between">
		...
		<article class="col-12 col-md-6 tm-post">
			<hr class="tm-hr-primary">
			<a href="commu.cu" class="effect-lily tm-post-link tm-pt-20">
				<div class="tm-post-link-inner">
					<img src="img/img-04.jpg" alt="Image" class="img-fluid">
				</div>
				<h2 class="tm-pt-30 tm-color-primary tm-post-title">여기는 커뮤니티</h2>
			</a>
			<p class="tm-pt-30">근데 여기에 커뮤니티 뭐 하면될까 관리팁 넣으면 될것같긴함</p>
			<div class="d-flex justify-content-between tm-pt-45">
				<span class="tm-color-primary">Artworks . Design</span> <span
					class="tm-color-primary">June 4, 2020</span>
			</div>
			<hr>
			<div class="d-flex justify-content-between">
				<span>72 comments</span> <span>by Admin Sam</span>
			</div>
		</article>
	</div>
